...
import ResumeItem from './ResumeSection';
    ...
    <ResumeSection id="experience" title="Experience">
      ...
      >
        ...
        <ul>
          ...
          <li>
            Responsible of the renovation and customization of styles and themes
            of the applications
          </li>
      ...
      >
        ...
        <p>
          Following Agile methodologies like Scrum and Kanban, hand in hand with
          TDD.
        </p>
        <p>
