          ...
          >
            <div className="w-100">
              ...
              <p className="lead mb-5">
                I am a passionate and versatile developer that will adapt
                quickly to any environment and provide solutions focused on
            ...
            <div className="w-100">
              ...
              <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="resume-content">
                  ...
                  <ul>
                    ...
                    <li>
                      Refactoring of great part of the code to reusable
                      components
                    </li>
              ...
              <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="resume-content">
                  ...
                  <p>
                    Development of Angular and Node/Python applications on
              ...
              <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
                <div className="resume-content">
                  ...
                  <p>
                    Development of "Visit Gozo", built on esri maps, through
                    their framework ArcGIS.
                  </p>
                  <p>
                  ...
                  <p>
                    iOS version written in Swift, Android version written in
                    Java.
                  </p>
                </div>
                <div className="resume-date text-md-right">
